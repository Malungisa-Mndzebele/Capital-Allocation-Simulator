...
export class GameEngine {
    static processTurn(currentState: GameState): GameState {
        ...
        if (newState.player.relationshipStatus === 'Dating') relationshipCost = 200; // Dates, gifts
        if (newState.player.relationshipStatus === 'Married') relationshipCost = 800; // Shared life (though maybe income sharing later?)
