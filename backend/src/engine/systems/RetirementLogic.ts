import { RetirementState, RetirementAccount, MarketState, RetirementAccountType, VestingSchedule } from '../types';
...
export class RetirementLogic {
    ...
    static forfeitUnvestedContributions(account: RetirementAccount): RetirementAccount {
        const { vestedAmount, unvestedAmount } = this.applyVesting(account);
